...
function Home({ isLoggedIn }) {
  ...
  return (
    <div className="w-full h-[90vh] bg-pink-400 border border-black p-4 flex flex-col justify-start items-center">
      <div className="h-2/6">
        <div className="bg-black text-yellow-400 border-yellow-400 border rounded-md text-3xl p-4 font-bold italic mt-4">
          GameS
        </div>
      </div>
      <div className="h-4/6 text-2xl italic font-bold underline flex flex-col gap-2 bg-purple-400 border border-purple-700 rounded-xl w-2/3 justify-center items-center">
        <ul>
